...
export default function List() {
  ...
  return (
    <div className="flex flex-col py-6 gap-3">
        <h1 className='pt-4 font-bold text-xl'>History</h1>
        {Transactions}
    </div>
  )
}
...
function Transaction({category, handler}) {
    ...
    return (
        <div className="item flex justify-center bg-gray-50 py-2 rounded-r shadow-md" style={{borderRight: `8px solid ${category.color ?? "#e5e5e5"}`}}>
